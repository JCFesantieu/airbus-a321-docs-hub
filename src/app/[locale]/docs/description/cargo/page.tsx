    ...
    <div className="space-y-8">
      ...
      <div className="mx-auto max-w-5xl space-y-12">
        ...
        <section className="space-y-6">
          ...
          <ContentCard 
            title={dict.cargo.loc_dim_card_title}
            description={dict.cargo.loc_dim_card_desc}
          >
            <DiagramViewer 
        ...
        <section className="space-y-6">
          ...
          <ContentCard 
            title={dict.cargo.loading_card_title}
            description={dict.cargo.loading_card_desc}
          >
            <DiagramViewer 
